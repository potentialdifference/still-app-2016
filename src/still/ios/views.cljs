...
(defn home-view []
  [view {:style {:flex 1 :alignItems "center" :margin-left 30 :margin-right 30}}
   ...
   [text {:style (:text styles)}
    "Welcome to the Still App. This app allows you to take photographs of the performance. To work correctly it will need permission to use your phone's camera and camera roll. \n\n
